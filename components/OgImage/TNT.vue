...
<template>
  ...
  >
    <div
      class="flex absolute bottom-0 left-[-90%]" :style="{
        width: '200%',
        height: '200%',
    ...
    <div class="h-full w-full justify-between relative">
      <div class="flex flex-row justify-between items-start">
        ...
        <div v-if="Boolean(icon)" style="width: 30%; font-size: 250px; line-height: 1;" class="flex justify-end">
          <IconComponent :name="icon" style="margin: 0 auto; opacity: 0.7;" mode="svg" />
        </div>
      </div>
